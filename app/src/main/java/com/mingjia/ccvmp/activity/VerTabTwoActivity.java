...
import com.mingjia.ccvmp.utils.DividerItemDecoration;
...
public class VerTabTwoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ver_tab_two);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("验证实施小组成员和职责列表");
...
//        rl_table.addItemDecoration(new DividerItemDecoration(this, DividerItemDecoration.HORIZONTAL_LIST));
    ...
    public class MultipleItemAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public MultipleItemAdapter(Context context) {
            mTitles = context.getResources().getStringArray(R.array.text_table_two);
            mContext = context;
                ...
                view.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        WritePadDialog writeTabletDialog = new WritePadDialog(
                                VerTabTwoActivity.this, new DialogListener() {
                            @Override
                            public void refreshActivity(Object object) {
                                mTextView.setVisibility(View.GONE);
                                mSignBitmap = (Bitmap) object;
                                signPath = createFile("tabletwo"+getPosition());
